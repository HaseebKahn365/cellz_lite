...
enum ColorImageProvider {
  leaves('Leaves', 'assets/images/leaves.png'),
  peonies('Peonies', 'assets/images/peonies.jpg'),
  bubbles('Bubbles', 'assets/images/bubbles.jpg'),
  seaweed('Seaweed', 'assets/images/seaweed.jpg'),
  seagrapes('Sea Grapes', 'assets/images/seagrapes.jpg'),
  petals('Petals', 'assets/images/petals.jpg');
